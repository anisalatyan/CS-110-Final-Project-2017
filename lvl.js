...
backgroundImage2.src = "bg2.png";

let tweetyImage = new Image();
tweetyImage.src = "tweety.png";

let tweetymImage = new Image();
tweetymImage.src = "tweetymirrored.png";
...
let badImage2 = new Image();
badImage2.src = "bad2.png";
...
let draw1 = function() {
    ...
    let spacing = 0;
    let counter = 1;
    context.drawImage(backgroundImage2, 0, 0, canvas.width, canvas.height);
    ...
    let looper = function(arr, i) {
        ...
        context.drawImage(badImage2, monsters[i].x, monsters[i].y, monsters[i].width, monsters[i].height);
        looper(arr, i + 1);
    };
    looper(monsters, 0);
}
...
let win=function(){
        ...
        if ( RectsIntersection(hero.x, hero.y, hero.width, hero.height, food.x, food.y, food.width1, food.height1) && food.number !== 0) {
            ...
            if (food.number === 0) {
      	      ...
      	      hero.gameOver=true;
             setTimeout(function(){ window.location.href = "index3.html"; }, 3000);
            }
            //break;
